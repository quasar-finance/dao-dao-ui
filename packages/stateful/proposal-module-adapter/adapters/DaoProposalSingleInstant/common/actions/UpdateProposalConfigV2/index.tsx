...
import { Threshold } from '../../../../../../../quasar/contracts/DaoProposalSingleInstant.common'
import { ExecuteMsg } from '../../../../../../../quasar/contracts/DaoProposalSingleInstant.v2'
import {
  ContractName,
...
export const makeUpdateProposalConfigV2ActionMaker = ({
  ...
  return ({ t, chain: { chain_id: chainId } }) => {
    ...
    return {
      ...
      label: t('proposalModuleLabel.DaoProposalSingleInstant', {
        context:
